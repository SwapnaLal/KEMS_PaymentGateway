...
using System.Text;
using System.IO;
public partial class Pages_ResponseHandling : System.Web.UI.Page
{
            ...
            if (Request.Form["status"] == "success")
            {
                ...
                else
                {
                    ...
                    if (VerifyPayment(order_id, Request.Form["mihpayid"].ToString()))
                    {
                        ...
                        Response.Redirect("SuccessPage.aspx?mihpayid=" + Request.Form["mihpayid"].ToString() + "&firstname=" + Request.Form["firstname"]);
                    }
                    else
                        Response.Write("<h2>Payment Verification Failed...</h2><br />");
                        Response.Redirect("UnSuccessPage.aspx?mihpayid=" + Request.Form["mihpayid"].ToString());
